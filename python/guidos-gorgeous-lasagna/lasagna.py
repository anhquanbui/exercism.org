...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Function that takes two arguments: the number of layers you want to add to
    the lasagna and the time already spent baking and returns how many minutes
    you have spent cooking the lasagna in total.
    """
...
#  Docstrings are important for documentation, and anyone reading your code